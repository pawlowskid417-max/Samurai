          ...
          <FadeIn>
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">
                Życie w naszym klubie
              </h2>
              <p className="text-brand-300/70 mt-2 max-w-md">
                Zajrzyj za kulisy naszych treningów, zawodów i klubowej społeczności.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.1}>
        ...
        {galleryItems.length === 0 ? (
          <FadeIn>
            <div className="py-20 text-center border border-brand-800/40 rounded-3xl">
              <p className="text-brand-400 text-lg">Brak zdjęć w galerii.</p>
              <p className="text-brand-600 text-sm mt-1">Zajrzyj tu wkrótce.</p>
            </div>
          </FadeIn>
        ) : (
          <FadeIn>
