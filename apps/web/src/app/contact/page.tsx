...
export const metadata: Metadata = {
  title: "Contact Us - Dojo Academy",
  description: "Get in touch with Dojo Academy for any inquiries about classes, memberships, or events.",
};
    ...
    <div className="bg-surface">
      ...
      <section className="py-16 md:py-20 bg-brand-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <FadeIn>
            <p className="text-xs font-semibold tracking-widest uppercase text-brand-400 mb-3">Contact</p>
            ...
            <p className="text-brand-300/70 mt-3 text-lg max-w-xl">
              Questions about classes, schedules, or memberships? We'd love to hear from you.
            </p>
          </FadeIn>
        </div>
      </section>
